...
function RootComponent() {
    ...
    const marginRight = isDriversPage ? '0px' : (isTripInfoPanelCollapsed ? LAYOUT_SIZES.TRIP_PANEL_COLLAPSED : LAYOUT_SIZES.TRIP_PANEL_EXPANDED)

    const headerMarginRight = isDriversPage
        ? (isUnassignedPanelCollapsed ? LAYOUT_SIZES.UNASSIGNED_PANEL_COLLAPSED : LAYOUT_SIZES.UNASSIGNED_PANEL_EXPANDED)
        : "0px";
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div
                ...
                style={{
                    marginLeft: LAYOUT_SIZES.SIDEBAR_WIDTH,
                    marginRight
                }}
            >
                <div className="transition-all duration-300 ease-in-out"
                    style={{ marginRight: headerMarginRight }}>
                    <DashboardHeader
                        date={date}
